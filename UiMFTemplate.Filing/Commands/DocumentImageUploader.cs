namespace UiMFTemplate.Filing.Commands
{
	...
	/// </summary>
	[MyForm(Id = "document-image-uploader", PostOnLoad = true, Label = "Document/Image", SubmitButtonLabel = "Upload")]
	[CssClass(UiFormConstants.InputsHorizontalMultipleColumn)]
	public class DocumentImageUploader : AsyncForm<DocumentImageUploader.Request, DocumentImageUploader.Response>
	{
		private readonly IFileManager context;
		private readonly EntityFileManagerRegister entityFileManagers;
		private readonly UserContext userContext;

		public DocumentImageUploader(
			...
			string metadata = null)
		{
			...
			{
				Form = typeof(DocumentImageUploader).GetFormId(),
		...
		public class Request : IRequest<Response>
		{
			...
			[InputField(Label = "", Required = true, OrderIndex = 5)]
