namespace UiMFTemplate.Filing.Commands
{
	...
	/// </summary>
	[MyForm(Id = "document-uploader", PostOnLoad = true, Label = "Document", SubmitButtonLabel = "Upload")]
	[CssClass(UiFormConstants.InputsHorizontalMultipleColumn)]
	public class DocumentUploader : AsyncForm<DocumentUploader.Request, DocumentUploader.Response>
	{
		...
		public class Request : IRequest<Response>
		{
			...
			[InputField(Label = "Select document", Required = true, OrderIndex = 5)]
