namespace UiMFTemplate.Users.Security
{
	...
	public class UserActions : ActionContainer
	{
		...
		public static readonly SystemAction SetPassword = new SystemAction(nameof(SetPassword), UserManagementRoles.UnauthenticatedUser, UserManagementRoles.AuthenticatedUser);
