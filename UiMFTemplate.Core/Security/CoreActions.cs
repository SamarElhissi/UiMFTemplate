namespace UiMFTemplate.Core.Security
{
	...
	public class CoreActions : ActionContainer
	{
        ...
        public static readonly SystemAction ViewNotifications = new SystemAction(nameof(ViewNotifications), CoreRoles.SysAdmin, CoreRoles.Supervisor, CoreRoles.User);
